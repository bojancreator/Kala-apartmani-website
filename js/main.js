    ...
    $(document).ready(function () {
       ...
       $("#subscribe-form").on('submit', function (e) {
        ...
        function initialize() {
            var map;
            var panorama;
            var var_latitude = 45.202791; // Google Map Latitude
            var var_longitude = 13.605540; // Google Map Longitude
            var pin = 'images/icons/pin.svg';

            //Map pin-window details
            var title = "Apartment Hotel Adeo - Click to see";
            var hotel_name = "Apartment Hotel Adeo";
            var hotel_address = "Molindrio 16, 52440 Porec, Croatia";
            var hotel_desc = "Luxurious and spacious apartment hotel.";
            var hotel_more_desc = "tel. + 385 52 777 065";
        ...
        /*========== BOOK NOW BUTTON ==========*/
        var amountScrolled = 500;
        var book_now = $('#book-now-button');
        $(window).on('scroll', function () {
            if ($(window).scrollTop() > amountScrolled) {
                book_now.addClass('active');
            } else {
                book_now.removeClass('active');
            }
        });
